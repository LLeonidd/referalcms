...
class AddressController extends Controller
{
  ...
  public function update(Request $request)
  {
    ...
    Address::where(['id' => $request->id, 'user_id' => Auth::user()->id,])->update(['address' => $request->address,]);
    return response()->json(['success'=>'Адрес успешно обновлен']);
  }
  ...
  public function delete(Request $request)
  {
    ...
    Address::where(['id' => $request->id, 'user_id' => Auth::user()->id,])->delete();
